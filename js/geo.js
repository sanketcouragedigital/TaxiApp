 $(function() {
        ...
        //       var mumbai = new google.maps.LatLng(19.0822507,72.8812042);
        //       var mapOptions = {
        //         zoom:7,
        //         center: mumbai
        //       };
        ...
        //     }
            ...
            function displayTaxiFares(distance, duration) {
                ...
                listItemHtml = '<li data-icon="phone"> <a href="'+currCab.contact+'">'+currCab.logo+" "+currCab.type+' <span class="ui-li-count"> Rs '+currCab.cost+' - Rs '+(parseFloat(currCab.cost) + 50).toFixed(2)+'</span></a></li>';
